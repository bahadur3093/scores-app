...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/bahsingh/Documents/GitHub/scores3093/libs/prisma/src/generated/prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/bahsingh/Documents/GitHub/scores3093/libs/prisma/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": "../../../.env",
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "libs/prisma/src/generated/prisma",
...
path.join(process.cwd(), "libs/prisma/src/generated/prisma/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "libs/prisma/src/generated/prisma/schema.prisma")
